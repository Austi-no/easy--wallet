package com.easywallet.config.swagger;
...
public class Myswaggerconfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Easy Wallet Api").description("API reference guide for Easy Wallet developers").termsOfServiceUrl("https://www.google.com/").contact("Victor Or Austin").version("1.0").build();
    }
